<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="BookLists.aspx.cs" Inherits="OnlineBookShopProject.Views.Admin.Books.BookLists" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="mt-3">
                <div class="row justify-content-center">
                    <label class="col-md-1 control-label text-black align-self-center ">Book Name</label>
                    <div class="col-md-4">
                        <input id="txtBook" type="text" autocomplete="off" class="form-control border-black" runat="server" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-3 justify-content-center">
            <div class="col-md-4 text-center">
                ...
                <asp:Button ID="btnClear" Text="Clear" runat="server" class="btn btn-secondary" />
            </div>
        </div>
